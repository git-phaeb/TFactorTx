      ...
      <div className="flex-1 flex flex-col min-h-0">
        <div className="container mx-auto flex flex-col md:flex-row gap-8 px-4">
          ...
          <main className="flex-1 bg-white rounded-lg pt-4 pr-8 pb-8 pl-8 shadow-lg" style={{ border: '3px solid teal' }}>
            ...
            <section id="columns" className="mb-12 scroll-mt-24" style={{ border: '1px dashed #94a3b8' }}>
            ...
            <section id="methodology" className="mb-12 scroll-mt-24" style={{ border: '1px dashed #94a3b8' }}>
            ...
            <section id="sources" className="mb-12 scroll-mt-24" style={{ border: '1px dashed #94a3b8' }}>
            ...
            <section id="license" className="mb-12 scroll-mt-24" style={{ border: '1px dashed #94a3b8' }}>
